<template>
  <div>
    <div class="flex py-4 main border-b lg:hidden">
    ...
    <div>
      <div class="flex py-4 main border-b flex-col hidden lg:block">
        <div class="flex items-center">
          <div class="flex w-full justify-between">
            ...
            <div class="flex w-1/2 items-center">
              <div class="flex items-center mr-2">
                <div class="select-none">
                  <img src="../assets/icons/count-minus.svg" class="w-12 btn rounded-full shadow-none"
                       @click="countMinus">
                </div>
                ...
                <div>
                  <img src="../assets/icons/count-plus.svg" class="w-12 btn rounded-full shadow-none"
                       @click="countPlus">
                </div>
              </div>
